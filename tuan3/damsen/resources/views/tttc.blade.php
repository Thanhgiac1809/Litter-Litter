@extends('templates.index')fontend
@section('tttc')
<div class="bd">
    <div class="til">
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="pd">
                    ...
                    <p class="macode">ALT20210501</p>
                    <p class="vecong">Vé Cổng</p>
                    <p class="linehigh">---</p>
                    <p class="datesdnn">Ngày sử dụng: 31/05/2021</p>
                    <div class="check">
