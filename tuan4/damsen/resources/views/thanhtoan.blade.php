        ...
        <div class="row">
            <div class="col-lg-6 inf" style="margin-left: 300px;">
                ...
                <div class="ttct">
                    ...
                    <input class="intt" type="text" id="domain" name="domain" value=""  disabled />
                    <input style="margin-left: 50px;" class="inslv" onchange="setDomain()" id="myName" type="text"></input> 
                    <script>
                        function setDomain() {
                            let myInput = document.getElementById("myName");
                            let myName =  Number(myInput.value) * 50000 + " VNĐ";
                            document.getElementById('domain').setAttribute('value', myName);
                        }
                    </script>
                    <input style="margin-left:110px;  width: 234px;height: 56px;background: #FFFFFF;box-shadow: inset -1px 3px 3px rgba(179, 91, 11, 0.5);border-radius: 16px;flex: none;order: 0;flex-grow: 1;" type="date">
